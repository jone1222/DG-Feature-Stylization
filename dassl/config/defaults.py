...
_C.DATALOADER.TRAIN_X.N_LABEL = 0
...
# TEXTURE_TRANSFORM
_C.TRAINER.TEXTRANS = CN()
_C.TRAINER.TEXTRANS.LMDA_CONTRA = 1.0
_C.TRAINER.TEXTRANS.TAU_CONTRA = 0.05
_C.TRAINER.TEXTRANS.LMDA_CONSISTENCY = 5
_C.TRAINER.TEXTRANS.TEMP_CONSISTENCY = 0.5
_C.TRAINER.TEXTRANS.MEASURE_CONSISTENCY = 'kl'
_C.TRAINER.TEXTRANS.TRANSFORM_LL = 'permute'
_C.TRAINER.TEXTRANS.TRANSFORM_HH = 'blur'
_C.TRAINER.TEXTRANS.LL_PERMUTE_SCALE = 10
_C.TRAINER.TEXTRANS.HH_KERNEL_SIZE = 13
_C.TRAINER.TEXTRANS.LL_TRANSFORM_RATIO = 1.0
_C.TRAINER.TEXTRANS.HH_TRANSFORM_RATIO = 0.0
_C.TRAINER.TEXTRANS.BOTH_TRANSFORM_RATIO = 0.0
_C.TRAINER.TEXTRANS.ENCODE_MODE = 'pooling'
_C.TRAINER.TEXTRANS.use_mixup = 'false'
_C.TRAINER.TEXTRANS.USE_GROWING = False
_C.TRAINER.TEXTRANS.EMA_ALPHA = 0.9995
