...
_C.MODEL.CLASSIFIER.BIAS = False
...
# Feature_Stylization
_C.TRAINER.FEATSTYLE = CN()
_C.TRAINER.FEATSTYLE.LMDA_CONTRA = 0.3
_C.TRAINER.FEATSTYLE.TAU_CONTRA = 0.15
_C.TRAINER.FEATSTYLE.LMDA_CONSISTENCY = 12
_C.TRAINER.FEATSTYLE.TAU_CONSISTENCY = 0.5
_C.TRAINER.FEATSTYLE.MEASURE_CONSISTENCY = 'kl'
_C.TRAINER.FEATSTYLE.ENCODE_MODE = 'pooling'
_C.TRAINER.FEATSTYLE.SCALING_FACTOR = 10
_C.TRAINER.FEATSTYLE.LAYER_IDX = 2
